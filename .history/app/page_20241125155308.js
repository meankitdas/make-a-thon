                  ...
                  >
                    ...
                    >
                      ...
                      <div className="relative mr-6">
                        ...
                        >
                          {link.icon ? (
  <link.icon className={`w-6 h-6 text-transparent bg-clip-text bg-gradient-to-r ${link.color} group-hover:shadow-lg`} />
) : (
  <span className="w-6 h-6 text-gray-500">?</span> // Placeholder for missing icons
)}
                        </motion.div>
                      </div>
