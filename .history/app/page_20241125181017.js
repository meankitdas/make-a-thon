    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex flex-col items-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="relative bg-gray-300/50 backdrop-blur-sm rounded-lg p-2 border border-purple-500/20">
          <Image src={Jain} alt="Event Logo" width={1import dynamic from 'next/dynamic';

const ClientOnlyComponent = dynamic(() => import('../components/ClientOnlyComponent'), { ssr: false });00} height={100} />
        </div>

        {/* University Logo */}
        <div className="relative bg-gray-300/50 backdrop-blur-sm rounded-lg p-2 border border-purple-500/20">
          <Image src={crce} alt="Jain University Logo" width={100} height={100} />
        </div>
      </motion.div>
