            ...
            >
              <Link href={link.href}>
                ...
                >
                  ...
                  <div className={`absolute -inset-0.5 bg-gradient-to-r ${link.color} rounded-xl opacity-0 group-hover:opacity-75 blur transition duration-500`} />
                  
                  {/* Main container */}
                  <div className={`relative flex items-center bg-gradient-to-r ${link.bgGradient} p-6 rounded-xl backdrop-blur-md border border-white/10`}>
                    {/* Icon container with gradient background */}
                    <div className="relative mr-6">
                      <div className={`absolute inset-0 bg-gradient-to-r ${link.color} rounded-lg blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
                      <motion.div
                        className={`relative p-3 rounded-lg bg-gray-900/50 backdrop-blur-sm border border-white/10`}
                        initial={{ rotate: 0 }}
                      ...
                      >
                        ...
                        {React.createElement(link.icon, {
                          className: `w-6 h-6 bg-gradient-to-r ${link.color} bg-clip-text text-transparent`
                        })}
                      </motion.div>
                    </div>
