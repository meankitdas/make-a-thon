    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex flex-col items-center px-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div className="relative bg-black/50 backdrop-blur-sm rounded-lg p-2 border border-purple-500/20">
            <Image src={crce} alt="Event Logo" className="h-12 w-auto" />
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative bg-white/50 backdrop-blur-sm rounded-lg p-2 border border-purple-500/20">
            <Image
              src={Jain}
