  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex flex-col justify-center items-center px-4 relative overflow-hidden">
      ...
      <motion.div 
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        className="absolute top-8 w-full max-w-6xl flex justify-between items-center px-8 z-20"
      >
        {/* Event Logo */}
        <motion.div
        ...
        >
          ...
          <div className="relative bg-black/50 backdrop-blur-sm rounded-lg p-4 border border-purple-500/20">
            {/* Replace src with your actual event logo */}
            <img 
        ...
        >
          ...
          <div className="relative bg-black/50 backdrop-blur-sm rounded-lg p-4 border border-purple-500/20">
            {/* Replace src with your actual Jain University logo */}
            <img 
              src="/api/placeholder/150/60" 
      ...
      <div className="relative w-full max-w-2xl z-10 mt-24">
        {/* Timer section */}
        <motion.div
          variants={fadeInUp}
          initial="initial"
