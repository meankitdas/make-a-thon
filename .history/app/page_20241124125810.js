    ...
    <div className="text-center bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 min-h-screen flex flex-col justify-center items-center">
      ...
      <nav className="mt-8">
        <ul className="space-y-4">
          ...
          >
            <Link href="/events">
              <d className="text-white text-xl hover:text-yellow-300 hover:underline transition-all duration-300">
                Brief About Events
              </d>
            </Link>
          </motion.li>
          ...
          >
            <Link href="/make-a-thon">
              <div className="text-white text-xl hover:text-yellow-300 hover:underline transition-all duration-300">
