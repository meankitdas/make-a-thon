...
const Stopwatch = () => {
  // Set target date
  const targetDate = new Date("2024-11-25T113:59:25").getTime();
  ...
  // Determine if the time is in the last hour
  const isLastHour = timeLeft <= 60 * 60 * 1000; // 1 hour in milliseconds
